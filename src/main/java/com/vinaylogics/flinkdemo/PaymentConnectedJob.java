...
package com.vinaylogics.flinkdemo;
 ...
 */
public class PaymentConnectedJob {
...
//		payments.writeAsText("D:\\Flink\\Input.txt");
		DataStream<PaymentData> paymentsFiltered = payments.filter((FilterFunction<PaymentData>) value ->
				value.getStatus().equals(Status.STARTED.name()));

		paymentsFiltered.print();
		/*
